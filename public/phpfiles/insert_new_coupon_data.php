...
switch ($action) {
    case "newData":
        try {
            ...
            // 已登入可以領取的折價卷
            $sql = " INSERT INTO `coupon` (`coupon_id`, `coupon_discount_number`, `coupon_issue_date`, `coupon_valid_date`, `coupon_exp_date`, `coupon_quantity`, `coupon_given_numbers`, `coupon_pricing_condition`, `coupon_status`) VALUES (null, :coupon_discount_number, :coupon_issue_date, :coupon_valid_date, :coupon_exp_date, :coupon_quantity, '0', :coupon_pricing_condition, :coupon_status);
            ";
