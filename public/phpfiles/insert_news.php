...
//線上
// const MY_DIR = "../../../timevolts_pika/news";
//local
...
if( $_FILES["news_img"]["error"] === 0){
	...
	try{
		...
		//sql 指令
		$sql = "insert into news values (:news_id, :news_title, :news_img, :news_content, :news_add_date, :news_status, :news_item_id, :news_category, :news_hashtag)";
		//編譯, 執行
